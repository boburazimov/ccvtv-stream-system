...
class LocationResourceIT {
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().home(DEFAULT_HOME).latitude(DEFAULT_LATITUDE).longitude(DEFAULT_LONGITUDE).info(DEFAULT_INFO);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().home(UPDATED_HOME).latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE).info(UPDATED_INFO);
        return location;
    }
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getHome()).isEqualTo(DEFAULT_HOME);
        ...
        assertThat(testLocation.getInfo()).isEqualTo(DEFAULT_INFO);
    }
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.home(UPDATED_HOME).latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE).info(UPDATED_INFO);
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getHome()).isEqualTo(UPDATED_HOME);
        ...
        assertThat(testLocation.getInfo()).isEqualTo(UPDATED_INFO);
    }
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.home(UPDATED_HOME).longitude(UPDATED_LONGITUDE).info(UPDATED_INFO);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.home(UPDATED_HOME).latitude(UPDATED_LATITUDE).longitude(UPDATED_LONGITUDE).info(UPDATED_INFO);
