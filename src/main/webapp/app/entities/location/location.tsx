  ...
  return (
    <div>
      <h2 id="location-heading" data-cy="LocationHeading">
        Entity translation missing for ccvtvApp.location.home.title
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} /> Entity translation missing for ccvtvApp.location.home.refreshListLabel
          </Button>
          <Link to="/location/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp; Entity translation missing for ccvtvApp.location.home.createLabel
          </Link>
        </div>
      </h2>
      <div className="table-responsive">
        {locationList && locationList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('home')}>
                  Home <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {locationList.map((location, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{location.info}</td>
                  <td>{location.street ? <Link to={`/street/${location.street.id}`}>{location.street.id}</Link> : ''}</td>
          ...
          !loading && <div className="alert alert-warning">Entity translation missing for ccvtvApp.location.home.notFound</div>
        )}
      </div>
      {totalItems ? (
