...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './street.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STREET_LIST actions', async () => {
    ...
    it('dispatches FETCH_STREET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STREET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STREET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STREET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STREET actions', async () => {
      const expectedActions = [
        {
