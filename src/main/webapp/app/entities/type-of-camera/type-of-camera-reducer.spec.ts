...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEOFCAMERA_LIST actions', async () => {
    ...
    it('dispatches FETCH_TYPEOFCAMERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TYPEOFCAMERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TYPEOFCAMERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TYPEOFCAMERA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TYPEOFCAMERA actions', async () => {
      const expectedActions = [
        {
