          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  Regiob <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {cityList.map((city, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{city.name}</td>
                  <td>{city.info}</td>
                  <td>{city.regiob ? <Link to={`/region/${city.regiob.id}`}>{city.regiob.id}</Link> : ''}</td>
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`/city/${city.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
